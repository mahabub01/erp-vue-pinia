...
const { getData, removeSingleRecord } = useRoleStore();
      ...
      <BlockUI :blocked="blockedProgressLoading">
        ...
        <div class="card">
          ...
          >
            ...
            >
              <template #body="slotProps">
                <span class="image-text">{{ slotProps.data.company }}</span>
              </template>
            </Column>
            ...
            >
              <template #body="slotProps">
                <div v-html="setStatus(slotProps.data.active)"></div>
              </template>
            </Column>
                ...
                >
                  <label v-if="single_btn === 'view'">
                    <router-link
                      ...
                      :to="`/admin/roles/details/${slotProps.data.id}`"
                    >
                  ...
                  <label v-if="single_btn === 'update'">
                    <router-link
                      ...
                      :to="`/admin/roles/${slotProps.data.id}/edit`"
